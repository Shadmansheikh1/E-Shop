    ...
    <div className='row bg-dark'>
      ...
      <div className="col-lg-10">
        <div className="row row-cols-3 d-flex justify-content-center">
          {sliceItem.map((ele) => {
            return <div key={ele.id} className="card m-2" style={{ width: '16rem' }}>
              <img style={{ height: "200px" }} src={ele.thumbnail}
              ...
              <div className="card-body">
                ...
                <Link to="#" className="btn btn-primary" onClick={() => handleAddtoCart(ele)}>Add to Cart</Link>
              </div>
            </div>
